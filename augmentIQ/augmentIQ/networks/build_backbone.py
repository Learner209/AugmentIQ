...
class RGBSingleHead(nn.Module):
    ...
    def __init__(self, name='resnet50', head='linear', feat_dim=128, ckpt_path = None):
...
def build_model(opt):
    ...
    print(model_key, opt.arch, opt.head, opt.feat_dim)
    ...
    return RGBSingleHead("resnet50", "mlp", 128), None
